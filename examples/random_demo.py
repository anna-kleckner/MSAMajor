...
def main():
    ...
    #ask the user how many random numbers to generate and then generate that many random numbers
    print("\nUser generated random numbers\n---------------------------")
    start_value = int(input("Enter start value: "))
    stop_value = int(input("Enter stop value: "))
    number_of_random_values = int(input("How mnay random numbers do you want?: "))
